...
*Figure 1 shows the average maximum step reached by learners across the ten countries with most learnerss. Focusing on popular countries ensures that persistent comparison are meaningful and not influenced by small sample sizes.
...
The figure shows clear difference in learner persistence across countries with some consistently showing higher progression through the course than others..

*Figure 2 breaks down linear engagement into early dropouts and retained learners allowing a better view of disengagement patterns at the early stage of the course.
...
Countries with early dropout rates show that disengagement happens very early indicating that initial core structure or accessibility might create problem in the ongoing participation.
...
*Table 1 list countries classified as low persistence, which are priority candidates for targeting for targeted high offline or blended learning interventions
